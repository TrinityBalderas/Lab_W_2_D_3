...
const newOrders = orders.map((order) => order.price * order.tax);
...
// CODE HERE
const newPurchases = purchases.filter((purchas) => purchas.owner === "Bob").reduce((total, purchase) => total + purchase.price, 0);
